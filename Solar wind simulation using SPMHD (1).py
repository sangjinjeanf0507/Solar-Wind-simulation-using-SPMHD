...
def compute_forces_and_magnetic_effects():
    ...
    for i in range(num_actual_particles[None]):
        ...
        # 특수입자 → 일반입자 Biot-Savart 효과 (조건문으로 분기)
...
def main_simulation_loop():
    ...
    while window.running:
        ...
        compute_density_only()  # 루프 1: 밀도만 계산
        compute_forces_and_magnetic_effects()  # 루프 2: 힘/자기항/특수입자 효과 통합 처리
